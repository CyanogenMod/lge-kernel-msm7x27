...
tuning_reg_settings_array[] = {
  ...
  {0x001E, 0x0601, WORD_LEN},    	//771 	// PAD_SLEW_PAD_CONFIG
  ...
  {0x0990, 0x0080, WORD_LEN},   	// MCU_DATA_0
  {0x098E, 0xE826, WORD_LEN},   	// MCU_ADDRESS [PRI_A_CONFIG_AE_TRACK_BASE_TARGET] 11-04-21
  ...
  {0x3640, 0x0F70, WORD_LEN}, 	// P_G1_P0Q0     
  ...
  {0x364A, 0x0010, WORD_LEN},   // P_R_P0Q0      
  {0x364C, 0xE66E, WORD_LEN}, 	// P_R_P0Q1      
  {0x364E, 0x1631, WORD_LEN},   // P_R_P0Q2      
  {0x3650, 0x2210, WORD_LEN}, 	// P_R_P0Q3      
  {0x3652, 0xB1B1, WORD_LEN}, 	// P_R_P0Q4      
  {0x3654, 0x17D0, WORD_LEN},   // P_B_P0Q0      
  ...
  {0x365E, 0x1390, WORD_LEN}, 	// P_G2_P0Q0     
  ...
  {0x36CA, 0x4DB1, WORD_LEN},   // P_R_P2Q0      
  ...
  {0x0990, 0x000A, WORD_LEN}, 	// MCU_DATA_0
  {0x098E, 0xC907, WORD_LEN},  	// MCU_ADDRESS [S [CAM1_LL_DM_EDGE_TH_STOP]       2011.04.05
  ...
  {0x098E, 0xE877, WORD_LEN}, 	// MCU_ADDRESS [PRI_A_CONFIG_LL_END_SATURATION]   2011.04.05 
...
wb_mode_incandescent_reg_settings_array[] = {
  ...
  //polling
  {0x098E, 0xAC3B, WORD_LEN}, 	// MCU_ADDRESS [AWB_R_RATIO_PRE_AWB]
  {0x0990, 0x004f, WORD_LEN}, 	// 65 MCU_DATA_0  2011-04-20
  {0x098E, 0xAC3C, WORD_LEN}, 	// MCU_ADDRESS [AWB_B_RATIO_PRE_AWB]
  {0x0990, 0x002d, WORD_LEN}, 	// 28 MCU_DATA_0 2011-04-20
...
wb_mode_fluorescent_reg_settings_array[] = {
  ...
  {0x098E, 0xAC3C, WORD_LEN}, 	// MCU_ADDRESS [AWB_B_RATIO_PRE_AWB]
  {0x0990, 0x0034, WORD_LEN}, 	// 30 MCU_DATA_0   11-04-20
};
...
wb_mode_cloudy_reg_settings_array[] = {
  ...
  {0x098E, 0xAC3C, WORD_LEN}, 	// MCU_ADDRESS [AWB_B_RATIO_PRE_AWB]
  {0x0990, 0x0047, WORD_LEN}, 	// 4b MCU_DATA_0   2011-04-20
};
