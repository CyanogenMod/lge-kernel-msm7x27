 ...
 *
 *  Based on lis331dlh.c by hyesung.shin@lge.com
 *
...
#if defined(CONFIG_SENSOR_KR3DM)
/** The following define the IOCTL command values via the ioctl macros */
#define KR3DM_IOCTL_BASE 'a'
#define KR3DH_IOCTL_SET_DELAY       _IOW(KR3DM_IOCTL_BASE, 0, int)
#define KR3DH_IOCTL_GET_DELAY       _IOR(KR3DM_IOCTL_BASE, 1, int)
#define KR3DH_IOCTL_SET_ENABLE      _IOW(KR3DM_IOCTL_BASE, 2, int)
#define KR3DH_IOCTL_GET_ENABLE      _IOR(KR3DM_IOCTL_BASE, 3, int)
#define KR3DH_IOCTL_SET_G_RANGE     _IOW(KR3DM_IOCTL_BASE, 4, int)
#define KR3DH_IOCTL_READ_ACCEL_XYZ  _IOW(KR3DM_IOCTL_BASE, 8, int)
...
#else
/** The following define the IOCTL command values via the ioctl macros */
#define KR3DH_IOCTL_BASE 'K'
#define KR3DH_IOCTL_SET_DELAY		_IOW(KR3DH_IOCTL_BASE, 0, int)
#define KR3DH_IOCTL_GET_DELAY		_IOWR(KR3DH_IOCTL_BASE, 1, int)
#define KR3DH_IOCTL_SET_ENABLE		_IOWR(KR3DH_IOCTL_BASE, 2, int)
#define KR3DH_IOCTL_GET_ENABLE		_IOWR(KR3DH_IOCTL_BASE, 3, int)
#define KR3DH_IOCTL_SET_G_RANGE		_IOWR(KR3DH_IOCTL_BASE, 4, int)
#define KR3DH_IOCTL_READ_ACCEL_XYZ	_IOWR(KR3DH_IOCTL_BASE, 5, int)
#endif
...
static int kr3dh_get_acceleration_data(struct kr3dh_data *kr, int *xyz)
{
	...
	err = kr3dh_i2c_read(kr, &acc_data[0], 1);
	xyz[0] = (int)((signed char)acc_data[0]);

	err = kr3dh_i2c_read(kr,&acc_data[1], 1);
	xyz[1] = (int)((signed char)acc_data[1]);

	err = kr3dh_i2c_read(kr,&acc_data[2], 1);
