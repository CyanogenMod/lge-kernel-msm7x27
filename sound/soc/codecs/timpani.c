...
/* To be change to use dapm */
static struct adie_codec_register handset_ear_on[] = {
	{0x80, 0x02, 0x02},
	{0x80, 0x02, 0x00},
	{0x83, 0x03, 0x00},
	{0x8A, 0x0F, 0x03},
...
/* To be change to use dapm */
static struct adie_codec_register handset_ear_off[] = {
	{0x8A, 0x0F, 0x03},
	{0x31, 0x03, 0x00},
	{0x39, 0x01, 0x00},
};
...
static void timpani_spk_mute(struct snd_soc_codec *codec, int mute)
{
}
