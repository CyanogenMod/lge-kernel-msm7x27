...
#define MSM_TMR_BASE		IOMEM(0xF0016000)
#define MSM_TMR_PHYS		0x02000000
#define MSM_TMR_SIZE		SZ_4K

#define MSM_TMR0_BASE		IOMEM(0xF0017000)
#define MSM_TMR0_PHYS		0x02040000
#define MSM_TMR0_SIZE		SZ_4K

#define MSM_SCPLL_BASE		IOMEM(0xF0018000)
...
#define MSM_SMMU_GFX2D1_PHYS 0x07E00000
#define MSM_SMMU_GFX2D1_SIZE SZ_1M

#ifdef CONFIG_MSM_DEBUG_UART

#define MSM_DEBUG_UART_BASE	0xF1C40000
