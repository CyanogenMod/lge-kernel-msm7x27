...
struct clk msm_clocks_8x60[] = {
	...
	CLK_8X60("gsbi_sim_src_clk",	GSBI_SIM_SRC_CLK,	NULL, OFF),
	CLK_8X60("gsbi_sim_clk",	GSBI1_SIM_CLK,		NULL, OFF),
	CLK_8X60("gsbi_sim_clk",	GSBI2_SIM_CLK,		NULL, OFF),
	CLK_8X60("gsbi_sim_clk",	GSBI3_SIM_CLK,		NULL, OFF),
	CLK_8X60("gsbi_sim_clk",	GSBI4_SIM_CLK,		NULL, OFF),
	CLK_8X60("gsbi_sim_clk",	GSBI5_SIM_CLK,		NULL, OFF),
	CLK_8X60("gsbi_sim_clk",	GSBI6_SIM_CLK,		NULL, OFF),
	CLK_8X60("gsbi_sim_clk",	GSBI7_SIM_CLK,		NULL, OFF),
	CLK_8X60("gsbi_sim_clk",	GSBI8_SIM_CLK,		NULL, OFF),
	CLK_8X60("gsbi_sim_clk",	GSBI9_SIM_CLK,		NULL, OFF),
	CLK_8X60("gsbi_sim_clk",	GSBI10_SIM_CLK,		NULL, OFF),
	CLK_8X60("gsbi_sim_clk",	GSBI11_SIM_CLK,		NULL, OFF),
	CLK_8X60("gsbi_sim_clk",	GSBI12_SIM_CLK,		NULL, OFF),
	...
	CLK_8X60("csi_clk",		CSI1_CLK,
					&msm_camera_sensor_webcam.dev, OFF),
#else
