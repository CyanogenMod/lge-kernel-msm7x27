...
struct clk msm_clocks_8x60[] = {
	...
	CLK_8X60("csi_clk",		CSI1_CLK,		WEBCAM_DEV, 0),
	...
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,		WEBCAM_DEV, 0),
	...
	CLK_8X60("vcodec_pclk",		VCODEC_P_CLK,		NULL, 0),
