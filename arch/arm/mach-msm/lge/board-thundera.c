...
/* LGE_CHANGE_S [hyunhui.park@lge.com] 2010-07-10, LG Android Gadget */
...
static int thundera_reboot_key_detect(void)
{
...
struct lge_panic_handler_platform_data panic_handler_data = {
	.reboot_key_detect = thundera_reboot_key_detect,
};
#endif
...
/* decrease FB pmem size because thundera uses hvga
