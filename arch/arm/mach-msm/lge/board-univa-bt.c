/* arch/arm/mach-msm/lge/board-univa-bt.c
...
static int univa_bluetooth_toggle_radio(void *data, bool state)
{
	int ret;
...
static int univa_bluetooth_power(int on)
{
	int pin, rc;
...
/*      if (!gpio_get_value(CONFIG_BCM4330_GPIO_WL_REGON)) 
		    gpio_set_value(CONFIG_BCM4330_GPIO_WL_REGON, 1); \
*/
...
/*      if (!gpio_get_value(CONFIG_BCM4330_GPIO_WL_RESET)) 
         gpio_set_value(CONFIG_BCM4330_GPIO_WL_REGON, 0); 
*/
/* LGE_CHANGE_E, [jongpil.yoon@lge.com], 2011-01-07, <Add BCM4330> */
...
static struct bluetooth_platform_data univa_bluetooth_data = {
	.bluetooth_power = univa_bluetooth_power,
	.bluetooth_toggle_radio = univa_bluetooth_toggle_radio,
};

static struct platform_device msm_bt_power_device = {
	.name = "bt_power",
	.dev = {
		.platform_data = &univa_bluetooth_data,
	},		
};
...
static struct bluesleep_platform_data univa_bluesleep_data = {
...
static struct platform_device msm_bluesleep_device = {
	...
	.dev = {
		.platform_data = &univa_bluesleep_data,
	},	
};
