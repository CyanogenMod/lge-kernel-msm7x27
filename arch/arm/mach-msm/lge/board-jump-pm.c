/* arch/arm/mach-msm/lge/board-jump-pm.c
...
static struct dev_pm_ops jump_pwrsink_data = {
	.suspend_noirq = jump_pwrsink_suspend_noirq,
	.resume_noirq = jump_pwrsink_resume_noirq,
};

static struct platform_device jump_pwrsink_device = {
	.name = "lge-pwrsink",
	.id = -1,
	.dev = {
		.platform_data = &jump_pwrsink_data,
	},
};
...
{
	lcd_bl_power_state = BL_POWER_RESUME;
	platform_device_register(&jump_pwrsink_device);
}
