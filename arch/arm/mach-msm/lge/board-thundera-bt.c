/* arch/arm/mach-msm/lge/board-thundera-bt.c
...
static int thundera_bluetooth_toggle_radio(void *data, bool state)
{
	int ret;
...
static int thundera_bluetooth_power(int on)
{
	int pin, rc;
...
static struct bluetooth_platform_data thundera_bluetooth_data = {
	.bluetooth_power = thundera_bluetooth_power,
	.bluetooth_toggle_radio = thundera_bluetooth_toggle_radio,
};

static struct platform_device msm_bt_power_device = {
	.name = "bt_power",
	.dev = {
		.platform_data = &thundera_bluetooth_data,
	},		
};
...
static struct bluesleep_platform_data thundera_bluesleep_data = {
...
static struct platform_device msm_bluesleep_device = {
	...
	.dev = {
		.platform_data = &thundera_bluesleep_data,
	},	
};
