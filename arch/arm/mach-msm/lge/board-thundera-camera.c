/* arch/arm/mach-msm/board-thundera-camera.c
...
static struct platform_device *thundera_camera_devices[] __initdata = {
#if defined (CONFIG_ISX005)
...
{
	platform_add_devices(thundera_camera_devices, ARRAY_SIZE(thundera_camera_devices));
}
