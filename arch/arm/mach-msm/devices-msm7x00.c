...
struct clk_lookup msm_clocks_7x01a[] = {
	...
	CLK_PCOM("mddi_clk",	EMDH_CLK,	"msm_mddi.1", OFF),
	...
	CLK_PCOM("mdp_clk",	MDP_CLK,	"msm_mdp.0", OFF),
	CLK_PCOM("pbus_clk",	PBUS_CLK,	NULL, 0),
	CLK_PCOM("pcm_clk",	PCM_CLK,	NULL, 0),
	CLK_PCOM("mddi_clk",	PMDH_CLK,	"msm_mddi.0", OFF | CLK_MINMAX),
	...
	CLK_PCOM("uart_clk",	UART2_CLK,	"msm_serial.1", OFF),
	CLK_PCOM("uart_clk",	UART3_CLK,	"msm_serial.2", OFF),
	CLK_PCOM("uartdm_clk",	UART1DM_CLK,	"msm_serial_hs.0", OFF),
	CLK_PCOM("uartdm_clk",	UART2DM_CLK,	"msm_serial_hs.1", OFF),
